...
- 감사 이력(원장 A-01~A-34 · 리뷰 라운드 · 루프 산물 · 실행 검증 기록): 트리에 없다. git 태그 `audit-2026-08` — `git show audit-2026-08:docs/audit-ledger.md`. 다음 감사는 원장 «종료» 절의 미해결 잔여와 2026-08-29·2026-08-31 후속(둘 다 무서명)부터 본다
